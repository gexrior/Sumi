...
<div class="home-masthead">
    <div class="container">
        <nav class="home-nav">
            <a class="home-nav-item active glyphicon glyphicon-home" href="">起始页</a>
            <a class="home-nav-item" href="#">文章管理</a>
            ...
            <a class="home-nav-item navbar-right glyphicon glyphicon-edit" href="">写新文章</a>
        </nav>
    </div>
</div>
